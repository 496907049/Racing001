...
public class NewsActivity extends BaseActivity implements IBaseView,BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showBuildBean();
        basePresent = new IBasePresentImpl(this, this);

...
public class IBasePresentImpl implements IBasePresent {

    private Context context;
    private IBaseView baseView;

    public IBasePresentImpl(IBaseView baseView, Context context) {
        ...
        HttpClientUtil.getInstance(context).get(url,new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    if (string != null) {
                        Gson gson = new Gson();
                        List<News> beanList = (List<News>) gson.fromJson(string, new TypeToken<List<News>>() {}.getType());

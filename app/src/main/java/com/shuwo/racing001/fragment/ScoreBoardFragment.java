...
public class ScoreBoardFragment extends BaseFragment implements IBaseView,IScoreBoardView,SwipeRefreshLayout.OnRefreshListener,BaseQuickAdapter.RequestLoadMoreListener{
    ...
    private IBasePresent newsPresent;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //获取接口<F1赛车新闻>数据
        newsPresent = new IBasePresentImpl(this,getContext());
        return fragmentView;
    }
    ...
    public void onLoadMoreRequested() {
        pageSize += 10;
        newsPresent.getLoadMoreInfoList("f1sallNewsAccess",pageSize,"yes");
    }
    ...
    public void showScoreboardList(List<ScoreBoard> scoreList) {
        ...
        newsPresent.getInfoList("f1sallNewsAccess",pageSize,"yes");
    }
